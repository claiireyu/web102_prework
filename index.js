...
const unfundedGamesString = numUnfundedGames > 0 ? `We have ${numUnfundedGames} unfunded games.` : "We don't have any unfunded games.";

// create a new DOM element containing the template string and append it to the description container
const unfundedGamesElement = document.createElement("p");

const displayStr = 
  `A total of $${totalRaised.toLocaleString()} has been raised for ${GAMES_JSON.length} games. Currently, ${numUnfundedGames} game${numUnfundedGames === 1 ? ' remains' : ' remain'} unfunded. We need your help to fund these amazing games!`;
